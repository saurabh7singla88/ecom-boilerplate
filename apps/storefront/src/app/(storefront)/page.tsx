import { formatPaise } from "@ecom/shared";
...
export default async function HomePage() {
  const newArrivals = await listProducts({ page: 1, limit: 4, sort: "newest" });
  ...
  return (
    <div className="flex flex-col gap-16">
      ...
      {newArrivals.items.length > 0 && (
        <section aria-labelledby="new-arrivals" className="flex flex-col gap-6">
          <div className="flex items-baseline justify-between">
            <h2 id="new-arrivals" className="text-2xl font-semibold tracking-tight">
              New arrivals
            </h2>
